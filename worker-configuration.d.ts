/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 904db01a48416bb83c7b1c45df8d704c)
...
declare namespace Cloudflare {
	interface Env {
		...
		TWITCH_SCOPES: "openid user:read:email channel:bot user:bot channel:manage:moderators moderator:read:chatters user:write:chat";
		BACKEND_SERVICE: Fetcher /* request-bot-backend */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "TWITCH_BOT_USERNAME" | "TWITCH_SCOPES">> {}
}
