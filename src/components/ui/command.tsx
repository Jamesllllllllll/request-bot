...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      >
        <Command className="**:data-[slot=command-input-wrapper]:h-12 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:text-oklch(0.553 0.013 58.071) [&_[cmdk-group]]:px-2 [&_[cmdk-group]:not([hidden])_~[cmdk-group]]:pt-0 [&_[cmdk-input-wrapper]_svg]:h-5 [&_[cmdk-input-wrapper]_svg]:w-5 [&_[cmdk-input]]:h-12 [&_[cmdk-item]]:px-2 [&_[cmdk-item]]:py-3 [&_[cmdk-item]_svg]:h-5 [&_[cmdk-item]_svg]:w-5 dark:[&_[cmdk-group-heading]]:text-oklch(0.709 0.01 56.259)">
          {children}
        </Command>
      </DialogContent>
    </Dialog>
...
function CommandGroup({
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        "overflow-hidden p-1 text-oklch(0.147 0.004 49.25) [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:text-oklch(0.553 0.013 58.071) dark:text-oklch(0.985 0.001 106.423) dark:[&_[cmdk-group-heading]]:text-oklch(0.709 0.01 56.259)",
        className
      )}
      {...props}
    />
...
function CommandSeparator({
  ...
  return (
    <CommandPrimitive.Separator
      ...
      className={cn(
        "-mx-1 h-px bg-oklch(0.923 0.003 48.717) dark:bg-oklch(1 0 0 / 10%)",
        className
      )}
      {...props}
    />
...
function CommandShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-xs tracking-widest text-oklch(0.553 0.013 58.071) dark:text-oklch(0.709 0.01 56.259)",
        className
      )}
      {...props}
    />
