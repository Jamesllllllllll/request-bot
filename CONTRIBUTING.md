...
- Keep [CHANGELOG.md](repo/CHANGELOG.md) and [package.json](repo/package.json) in sync when preparing a release PR.
...
- [docs/local-development.md](repo/docs/local-development.md)

## Database changes

- Put schema changes in [src/lib/db/schema.ts](repo/src/lib/db/schema.ts)
- Generate or add the matching SQL migration in [drizzle](repo/drizzle)
