...
export function DashboardPageHeader(props: DashboardPageHeaderProps) {
  return (
    <section className="surface-grid surface-noise rounded-[34px] border border-(--border-strong) bg-(--panel) p-6 shadow-(--shadow) md:p-8 max-[960px]:rounded-none max-[960px]:border-0 max-[960px]:bg-transparent max-[960px]:px-0 max-[960px]:py-4 max-[960px]:shadow-none max-[960px]:[background-image:none]">
